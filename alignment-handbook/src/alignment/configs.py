...
class DPOConfig(transformers.TrainingArguments):
    ...
    self_refine_threshold: Optional[int] = field(
        default=0.1,
        metadata={"help": ("SPA's self_refine_threshold")},
    )
    refine_stragth: Optional[int] = field(
        default=0.1,
        metadata={"help": ("SPA's self_refine_stragth")},
    )
    decouple_denoising: Optional[int] = field(
        default=1,
        metadata={"help": ("SPA's self_refine_threshold")},
    )
    ...
    confidence_dir: Optional[str] = field(default="save_confidence", metadata={"help": ("save point of reward from response")})
    ref_model_for_refine: Optional[str] = field(default="alignment-handbook/zephyr-7b-sft-full", metadata={"help": ("reference model for self labeling")})
